...
\end{figure}
 ...
 The Iterative Boltzmann Inversion is a reasonable methodology to apply in the initials iterations, since it has fast convergence. The process derives from ... \cite{ibi}
 
 Regarding the Inversion Monte Carlo process it follows the methodology described by \citeA{imc}. Given a space of Hamiltonians:
 \begin{equation}
