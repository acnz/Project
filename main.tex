...
Next, another characteristic of the system is the Coordination number. In this case, the coordination number represent the number of molecules surrounding one single molecule. The formation of the layer independently of the concentration should have the same coordination number. This property can be measured directly by integrating the RDF of the N-N interactions within the range of the first peak using Equ. ()   because the N atoms, which are polar heads, are representatives the position of each molecule in the layer. 
